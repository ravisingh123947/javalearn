...
public class TestJavers {
    public static void main(String[] args) {
        ...
        //***contains all kind of changes valueChanges ,Listchanges,Referecnce changes***///

        Student student1 = new Student();
        student1.setId(1);
        student1.setName("raviranjan");
        student1.setFavouriteSubject(Arrays.asList("math","science"));
        student1.setTeachers(null);
        ...
        student2.setTeacherList(Arrays.asList(new Teacher(1,"rj"),new Teacher(2,"rm"),new Teacher(3,"shubham")));
